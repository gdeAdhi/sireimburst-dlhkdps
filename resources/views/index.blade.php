                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a data-toggle="modal" data-target="#modal-hapus{{ $d->id }}" href="" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Delete</a> 
                            </td>
                          </tr>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <p>Apakah anda ingin menghapus data user <b>{{ $d->name }}</b></p>
                                </div>
